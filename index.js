...
class Task {
  constructor(name, description, priority, dueDate = 'No due date') {
    ...
    this.UUID = (this.UUID) ? this.UUID : (0,uuid__WEBPACK_IMPORTED_MODULE_0__["default"])()
  }
...
class userInterface {
  ...
  static validateModalProjectName(modalType, projectName, buttonProjectName = null) {
    ...
    if (modalType === 'add') {
      ...
      if (_storage__WEBPACK_IMPORTED_MODULE_0__["default"].getTodoList().contains(projectName) && projectName !== buttonProjectName) {
        modalErrorSpan.textContent = 'Project already exists, please choose a different name!'
        return
      }
    }
  ...
  static handleEditProjectButton(projectName, button) {
    ...
    _storage__WEBPACK_IMPORTED_MODULE_0__["default"].setProjectName(projectName, projectNameInputValue)
  ...
  static openEditTaskForm(taskElement) {
    const projectName = taskElement.querySelector('.task-project-name').textContent
    const taskName = taskElement.querySelector('.task-name').textContent
    const taskUUID = _storage__WEBPACK_IMPORTED_MODULE_0__["default"].getTodoList().getProject(projectName).getTask(taskName).getUUID()
    const task = _storage__WEBPACK_IMPORTED_MODULE_0__["default"].getTodoList().getProject(projectName).getTaskByUUID(taskUUID)
  ...
  static editTask(taskUUID) {
    ...
    _storage__WEBPACK_IMPORTED_MODULE_0__["default"].setTaskName(originProjectName, taskUUID, formTaskName)
    _storage__WEBPACK_IMPORTED_MODULE_0__["default"].setTaskDescription(originProjectName, taskUUID, formTaskDescription)
    _storage__WEBPACK_IMPORTED_MODULE_0__["default"].setTaskDueDate(originProjectName, taskUUID, formTaskDueDate)
    _storage__WEBPACK_IMPORTED_MODULE_0__["default"].setTaskPriority(originProjectName, taskUUID, formTaskPriority)
  ...
  static setTaskCompletionState(taskElement) {
    ...
    const projectName = taskElement.querySelector('.task-project-name').textContent
    const isTaskCompleted = _storage__WEBPACK_IMPORTED_MODULE_0__["default"].getTodoList().getProject(projectName).getTask(taskName.textContent).isCompleted()

    if (isTaskCompleted) {
      _storage__WEBPACK_IMPORTED_MODULE_0__["default"].setTaskCompletion(projectName, taskName.textContent, false)
      taskName.style.textDecoration = null
    } else {
      _storage__WEBPACK_IMPORTED_MODULE_0__["default"].setTaskCompletion(projectName, taskName.textContent, true)
  ...
  static switchTheme(e) {
    if (e.target.checked) {
      ...
      _storage__WEBPACK_IMPORTED_MODULE_0__["default"].setTheme('dark')
    } else {
      document.documentElement.setAttribute('data-theme', 'light')
      _storage__WEBPACK_IMPORTED_MODULE_0__["default"].setTheme('light')
    }
  }

  static loadTheme() {
    const toggleSwitch = document.querySelector('.theme-switch input[type="checkbox"]');
    const currentTheme = _storage__WEBPACK_IMPORTED_MODULE_0__["default"].getTheme() ? _storage__WEBPACK_IMPORTED_MODULE_0__["default"].getTheme() : null
