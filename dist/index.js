...
class Storage {
  ...
  static getTodoList() {
    const todoList = Object.assign(
      new _todo_list__WEBPACK_IMPORTED_MODULE_2__["default"],
...
class Task {
  constructor(name, description, priority, dueDate = 'No due date', sourceProject = null) {
    this.name = name
...
class TodoList {
  constructor() {
    this.projects = []
    this.projects.push(new _project__WEBPACK_IMPORTED_MODULE_0__["default"]('General', '#DF6161'))
    this.projects.push(new _project__WEBPACK_IMPORTED_MODULE_0__["default"]('Today', null))
    this.projects.push(new _project__WEBPACK_IMPORTED_MODULE_0__["default"]('This week', null))
  }
  ...
  updateTodayProject() {
    ...
    this.projects.forEach(project => {
      ...
      todayTasks.forEach(task => {
        // task.setSourceProject(project.getName())
        this.getProject('Today').addTask(task)
      })
    })
  }
  ...
  updateWeekProject() {
    ...
    this.projects.forEach(project => {
      ...
      weekTasks.forEach(task => {
        // task.setSourceProject(project.getName())
        this.getProject('This week').addTask(task)
      })
    })
      ...
      this.getProject('This week')
        ...
        .sort((taskA, taskB) =>
          (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(
            (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(taskA.getDateFormatted())),
            (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(taskB.getDateFormatted()))
          )
        )
    )
  }
...
class userInterface {
  ...
  static getDateFormatted(date) {
    if (date !== 'No due date') {
      ...
      date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(year, month - 1, day), 'PPP')
    }
    return date
  }
  ...
  static createTask(name, description, priority, dueDate, projectName) {
    ...
    const projectColor = _storage__WEBPACK_IMPORTED_MODULE_0__["default"].getTodoList().getProject(projectName).getColor()
  ...
  static addProject(projectName) {
    ...
    const newProject = _storage__WEBPACK_IMPORTED_MODULE_0__["default"].getTodoList().getProject(projectName)
  ...
  static validateAddTaskForm(formType, taskElement = null) { // formType: String, 'add' or 'edit'
    ...
    if (formType === 'add') {
      if (_storage__WEBPACK_IMPORTED_MODULE_0__["default"].getTodoList().getProject(projectName).getTask(taskName)) {
  ...
  static addTask() {
    ...
    _storage__WEBPACK_IMPORTED_MODULE_0__["default"].addTask(projectName, new _task__WEBPACK_IMPORTED_MODULE_2__["default"](taskName, taskDescription, taskPriority, taskDueDate))
...
/* harmony import */ var _modules_todo_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/todo-list */ "./src/modules/todo-list.js");
...
document.addEventListener('DOMContentLoaded', _modules_user_interface__WEBPACK_IMPORTED_MODULE_0__["default"].loadHomePage)
